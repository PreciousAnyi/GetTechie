...
import com.kodecamo.gettechie.adapter.PlaylistAdapter
import com.kodecamo.gettechie.adapter.homePopularAdapter
import com.kodecamp.gettechie.DataSource
import com.kodecamp.gettechie.R
import com.kodecamp.gettechie.databinding.FragmentPlayListBinding


class popular_playListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView.adapter= homePopularAdapter(requireContext(),myDataSource)
